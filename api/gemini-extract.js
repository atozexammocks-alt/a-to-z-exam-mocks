...
const MAX_REQUEST_BYTES = 3900000;
const MAX_IMAGE_BASE64_CHARS = 3000000;

// Keep runtime failures visible in Vercel Logs instead of letting Node terminate silently.
if (typeof process !== 'undefined' && process.on) {
  process.on('uncaughtException', (err) => console.error('[Gemini] uncaughtException', err));
  process.on('unhandledRejection', (err) => console.error('[Gemini] unhandledRejection', err));
}
